...
em++ -g0  -Wall -std=c++17  -I ../core/includes  ../core/src/main.cpp ../tools/emscripten/main.cpp  -o ../build\mono\js\bind5.html --shell-file ../tools/emscripten/wasm.html  -s MINIFY_HTML=0 -s WASM=1   -s EXPORTED_FUNCTIONS=["_bindExecute"] -s EXTRA_EXPORTED_RUNTIME_METHODS=["cwrap","ccall"]  -s NO_EXIT_RUNTIME=1 
