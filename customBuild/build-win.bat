...
clang++ -g -O0 -Wall -Wextra -Wpedantic -std=c++17   -Wno-deprecated-declarations -o ..\build/mono/metacompiler.exe -I ..\core/includes ..\tools/metacompiler/main.cpp
...
clang++ -g -O0 -c -Wall  -Wextra -Wpedantic -std=c++17  -Wno-deprecated-declarations -o ..\build/mono/core.o -I ..\core/includes ..\core/src/main.cpp
