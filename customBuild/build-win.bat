...
clang++ -g -O0 -Wall -std=c++17 -Wno-format-security -Wno-deprecated-declarations -o ..\build/mono/metacompiler.exe -I ..\core/includes ..\tools/metacompiler/main.cpp
...
clang++ -g -O0 -Wall -std=c++17 -Wno-deprecated-declarations -o ..\build/mono/Tests.exe -I ..\core/includes ..\tests/src/main.cpp ..\build/mono/core.lib
echo -- test built
pushd ..\build\mono
.\Tests.exe
popd
